...
export const fontsStyle = () => {
    ...
    // Провіряєм чи існуют файли шрифтів
    fs.readdir(app.path.build.fonts, function (err, fontsFiles) {
        if (fontsFiles) {
            // провіряєи чи існує файл стилів для підключення шрифтів 
            if (!fs.existsSync(fontsFile)) {
                ...
                console.log("Файл scss/fonts.scss уже існує. Для обновлення файла потрібно його удалити")
            }          
        }
    });
